...
import { getCreche, getCrechePetsitters, getPosts, createCreche } from "../../../../services/api"
...
const HomeScreen: FC<StackScreenProps<NavigatorParamList, "home-screen">> = observer(
