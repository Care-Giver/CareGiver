...
import { StyleProp, View, ViewStyle, PretendardBold } from "react-native"
import { observer } from "mobx-react-lite"
import { PreBol14, PreReg12, PreMed12, PopSem12 } from "#components"
import { GIVER_CASUAL_NAVY, BODY } from "#theme"
...
export const CertificateRegistrationNote = observer(function CertificateRegistrationNote(
  ...
  return (
    <View style={{ backgroundColor: "#F8F8FA" }}>
      <View style={{ marginTop: 12, marginLeft: 16, marginBottom: 12, marginRight: 16 }}>
